...
<body>
    <form method="post" action="${pageContext.request.contextPath}/editProductServlet" enctype="multipart/form-data">
        <table width="100%" align="center" bgcolor="#eeeeee" style="border:1px solid #8ba7e3">
            ...
            <tr>
                ...
                <td><input type="text" name="name" class="bg" value="${p.name}"></td>
                <td align="center" bgcolor="#f5fafe">商品价格</td>
                <td><input type="text" name="price" class="bg" value="${p.price}"></td>
            </tr>
            <tr>
                <td align="center" bgcolor="#f5fafe">商品数量</td>
                <td><input type="text" name="pnum" class="bg" value="${p.pnum}"></td>
            ...
            <tr>
                ...
                <td colspan="3"><textarea name="description" cols="30" rows="3" width=""96%>${p.description}</textarea></td>
            </tr>
            <tr>
